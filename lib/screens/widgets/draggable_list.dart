...
import 'package:new_design/screens/widgets/my_screen.dart';
      ...
      builder: (context, state) {
        return GestureDetector(
          onTapDown: (de){
            ...
            homeBloc.add(LongPressEvent(longPress: onLongPress));
          },
          ...
          child: DraggableBottomSheet(
            ...
            expandedChild: Container(
              ...
              child: Column(children: <Widget>[
                ...
                tranzaksiWidget("assets/icons/beeline.png", "Farhod Yusubov ",
                    "91 526 47 88", 10000),
              ]),
            ),
